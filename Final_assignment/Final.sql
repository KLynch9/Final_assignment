...
values('Welcome to the Chestermere Zoo! We are very excited to see you, so come on down and see us','#welcome'),
...
AS
BEGIN
	Select top 1 ParagraphText from tbParagraphText where ParagraphName ='#welcome' order by id desc
END
GO
